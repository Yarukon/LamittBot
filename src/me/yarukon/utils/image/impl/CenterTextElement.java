...
public class CenterTextElement extends Element {
	public String text;

	public CenterTextElement(int x, int y, int width, int height, int space, String text) {
	...
	public void doDraw(Graphics2D g) {
		...
		Rectangle2D textBound = ImageUtils.font2.getStringBounds(text, g.getFontRenderContext());
