    ...
    public void action() throws Exception {
        ...
        if (dataCenterName != null || BotMain.INSTANCE.isDataCenterExist(zoneOrWorld) || BotMain.INSTANCE.isZoneExist(zoneOrWorld)) {
            ...
            if (FFXIVUtil.containsItem(itemName, nameLikeItems)) {
                ...
                String result = BotUtils.sendGet("https://universalis.app/api/v2/" + URLEncoder.encode(zoneOrWorld, "UTF-8") + "/" + itemID, "listings=" + listingAmount + (isHQ ? "&hq=true" : onlyNQ ? "&hq=false" : "") + "&fields=" + FFXIVUtil.requestFields, true);
